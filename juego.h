...
int jugarPartida(SDL_Renderer *renderer, SDL_Texture *texturaFondo, Configuracion *cfg, Jugador *j1, Jugador *j2, TTF_Font *font);
...
void dibujarHUD(SDL_Renderer *renderer, TTF_Font *font, Jugador *j1, Jugador *j2, int jugadorActual, int cantJugadores, int paresEncontrados, int totalPares);
